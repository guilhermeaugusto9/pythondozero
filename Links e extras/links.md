...
# Módulo 2 - Manipulando Arquivos com Python
...
* [Useful Snippets for Google Colab](https://medium.com/machine-learning-world/useful-snippets-for-google-colaboratory-free-gpu-included-d976d6b3e6de)

* [5 Amazing Google Colab Hacks You Should Try Today - Analytics Vidhya](https://www.analyticsvidhya.com/blog/2020/04/5-amazing-google-colab-hacks-you-should-try-today/)
...
* [Manipulando Strings com Python - Python Brasil](https://wiki.python.org.br/ManipulandoStringsComPython)

* [Strings and Character Data in Python](https://realpython.com/python-strings/)


# Módulo 3 - Visualizando Gráficos com Python

* [Plot With Pandas: Python Data Visualization for Beginners](https://realpython.com/pandas-plot-python/)

* [Python Matplotlib Guide - Real Python](https://realpython.com/python-matplotlib-guide/)


* [Line Chart with Python and Matplotlib - Data to Fish](https://datatofish.com/line-chart-python-matplotlib/)

* [Bar Charts - Documentação Matplotlib](https://matplotlib.org/3.1.1/api/_as_gen/matplotlib.pyplot.bar.html)

* [Barplot - Python Gallery](https://python-graph-gallery.com/barplot/)

* [Histograms - DataCamp](https://www.datacamp.com/community/tutorials/histograms-matplotlib?utm_source=adwords_ppc&utm_campaignid=1455363063&utm_adgroupid=65083631748&utm_device=c&utm_keyword=&utm_matchtype=b&utm_network=g&utm_adpostion=&utm_creative=332602034364&utm_targetid=aud-763347114660:dsa-429603003980&utm_loc_interest_ms=&utm_loc_physical_ms=1001541)

* [Python Histogram Plotting: NumPy, Matplotlib, Pandas & Seaborn](https://realpython.com/python-histograms/)

*[Matplotlib scatterplot](https://pythonspot.com/matplotlib-scatterplot/)

* [Why We Don't Use Pie Charts - Tips For Better Data Visualization](https://blog.funnel.io/why-we-dont-use-pie-charts-and-some-tips-on-better-data-visualizations)

* [ALTERNATIVE CHART TYPES FOR PIE CHART](https://dataviz.love/2017/03/17/alternative-chart-types-pie-chart/)

* [O que é e como interpretar um Diagrama de Caixa - EDTI](https://www.escolaedti.com.br/o-que-e-um-box-plot)

* [Waffle Charts Using Python's Matplotlib - Towards Data Science](https://towardsdatascience.com/waffle-charts-using-pythons-matplotlib-94252689a701)

* [Como Criar um Gráfico de Waffle no Python - Sigmoidal](https://www.youtube.com/watch?v=wT4YEqHWsyU&list=PL0xsCSq4OpBxxg23H6v7VBLTuyTnY91s8&index=5&t=0s)

* [Repositório do Pandas Profiling](https://github.com/pandas-profiling/pandas-profiling)

* [Exemplos de relatórios com o Pandas Profiling](https://pandas-profiling.github.io/pandas-profiling/docs/master/rtd/pages/examples.html#showcasing-specific-features)
